...
class RunTaskTest {
  ...
  /**
   * Tests that the run task makes entity run from target.
   */
  @Test
  ...
  /**
   * Tests that the run task only makes entity run within a certain distance.
   */
  @Test
  void shouldRunOnlyWhenInDistance() {
    Entity target = new Entity();
    ...
    // When active, should not run outside chase distance
