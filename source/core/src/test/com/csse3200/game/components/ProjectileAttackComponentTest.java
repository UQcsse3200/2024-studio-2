...
class ProjectileAttackComponentTest {
  ...
  Entity createProjectile(short targetLayer, Entity target) {
    Entity projectile = new Entity()
            ...
            .addComponent(new CombatStatsComponent(0, 100, 2, 0, 0, 0, false, false, 1))  // Attack damage is 2
  ...
  Entity createTarget(short layer) {
    Entity target = new Entity()
            .addComponent(new CombatStatsComponent(10, 100, 0, 0, 0, 0, false, false, 1))  // Initial health is 10
            .addComponent(new PhysicsComponent())
