...
class ProjectileAttackComponentTest {
  ...
  Entity createProjectile(short targetLayer) {
    Entity projectile = new Entity()
            ...
            .addComponent(new CombatStatsComponent(0, 100, 2, 0, 0, 0, 0, false))  // Attack damage is 2
  ...
  Entity createTarget(short layer) {
    Entity target = new Entity()
            .addComponent(new CombatStatsComponent(10, 100, 0, 0, 0, 0, 0, false))  // Initial health is 10
            .addComponent(new PhysicsComponent())
