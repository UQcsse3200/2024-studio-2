...
public class ForestSpawnConfig {
    ...
    public static final int NUM_FRIED_FISH = 2;
    public static final int NUM_SHRIMP = 2;
    public static final int NUM_CLOUD_CUPCAKES = 2;
    public static final int NUM_CLOUD_COOKIES = 2;
