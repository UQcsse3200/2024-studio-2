 ...
 */
public class WaterSpiralTask extends DefaultTask implements PriorityTask {
    private static final Logger logger = LoggerFactory.getLogger(WaterSpiralTask.class);
     ...
     */
    public WaterSpiralTask(float waitTime, Entity target, float range) {
